...
const FilterProducts = (props: IFilterProps) => {
    let { isSearchBar, isFooter, productDetail, navigation, elements, isForeginData } = props;
                ...
                <SearchStoreLoader />
                    ...
                    <LayoutContainer
                        ...
                        <Suspense fallback={<ProductLoader />}>
                            {(listElements || masterProductList) ? _uniqBy((listElements || masterProductList), 'pId').map((e) => (
                                <ListProduct
                                    navigation={navigation}
                                    refresh={() => isResresh()}
                                    elements={e}
                                />
                            )) : <RowText fontColor="black" fontFormat="Italic">No Product Found</RowText>}
                        </Suspense>
                    </LayoutContainer>
                )}
            <View style={{ bottom: 0 }}>
